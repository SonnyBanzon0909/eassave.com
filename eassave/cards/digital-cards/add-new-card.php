...
<html data-wf-page="665f147b743ba95cae446d74" data-wf-site="665f147b743ba95cae446cfe">
<head>
  <meta charset="utf-8">
  <title>Add New Card</title>
  <meta content="Add New Card" property="og:title">
  <meta content="Add New Card" property="twitter:title">
        ...
        <div class="padding-global no-padding">
          <div class="container-large">
            <div class="user-profile-wrapper align-start padding-25 template-container">
              ...
              <div id="w-node-_48cfbcec-5917-1102-c51e-1b43d3059dd8-ae446d74" class="dashboard-container">
                <div class="bread-crumbs-wrapper">
                  ...
                  <div class="bread-crumbs-container">
                    <a href="../../cards/manage-cards.html" class="breadcrumbs">Dashboard</a><img src="../../images/bi_chevron-down.svg" loading="lazy" alt="">
                    <a href="../../cards/digital-cards/add-new-card.html" aria-current="page" class="breadcrumbs w--current">Digital Cards</a>
                  </div>
                </div>
                <div class="template-container">
                  <h1 class="heading-style-h6 weight-500">Select a template to start</h1>
                  <div class="swiper-container swiper-template">
                    <div class="swiper-wrapper template-wrapper">
                      <div class="swiper-slide template-slide">
                        <a id="w-node-_190458a8-eeec-9abf-d603-3a6ad4a2badd-ae446d74" href="../../cards/digital-cards/setup.html" class="phone-template w-inline-block"><img src="../../images/Template-1.png" loading="lazy" sizes="(max-width: 991px) 270px, 22vw" srcset="../../images/Template-1-p-500.png 500w, ../../images/Template-1.png 807w" alt="" class="template-content"></a>
                      </div>
                      <div class="swiper-slide template-slide">
                        <a id="w-node-_3330cc34-e923-bba8-b815-92f63c1fe8f3-ae446d74" href="../../cards/digital-cards/setup.html" class="phone-template w-inline-block"><img src="../../images/Template-4.png" loading="lazy" sizes="(max-width: 991px) 270px, 22vw" srcset="../../images/Template-4-p-500.png 500w, ../../images/Template-4.png 806w" alt="" class="template-content"></a>
                      </div>
                      <div class="swiper-slide template-slide">
                        <a id="w-node-_1849bd4c-59db-863f-42fe-98fe4e993d83-ae446d74" href="../../cards/digital-cards/setup.html" class="phone-template w-inline-block"><img src="../../images/Template-5.png" loading="lazy" sizes="(max-width: 991px) 270px, 22vw" srcset="../../images/Template-5-p-500.png 500w, ../../images/Template-5.png 806w" alt="" class="template-content"></a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="footer-wrapper">
              ...
              <div id="w-node-ef992205-966c-748f-d053-488a176f95be-176f958f" class="signup-wrapper">
                ...
                <div class="form-block w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="665f147b743ba95cae446d74" data-wf-element-id="ef992205-966c-748f-d053-488a176f95c4">
...
$(document).ready(function() {
  ...
  <script>
    ...
    // Initialize Swiper only if viewport width is <= 1024px (tablet and mobile)
    ...
    // Run check on page load and on window resize
