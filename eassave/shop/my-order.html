...
<html data-wf-page="665f147b743ba95cae446d5a" data-wf-site="665f147b743ba95cae446cfe">
<head>
  <meta charset="utf-8">
  <title>My Order - Coming soon</title>
  <meta content="My Order - Coming soon" property="og:title">
  <meta content="My Order - Coming soon" property="twitter:title">
        ...
        <div class="padding-global no-padding">
          <div class="container-large">
            <div class="user-profile-wrapper align-start">
              <div id="w-node-c67de879-8571-3066-c007-09fecf7d1e7e-cf7d1e7e" class="user-navigation-wrapper">
                <div class="user-button-wrapper">
                  ...
                  <div class="user-button-grid">
                    ...
                    <a href="../shop/my-order.html" aria-current="page" class="sidenav-button w-inline-block w--current">
                      <div class="icon color-blue w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewbox="0 0 16 16" fill="none">
              ...
              <div id="w-node-fd887fd3-e992-f2c8-b99f-8509ff66e936-ae446d5a">
                <div class="bread-crumbs-wrapper top-10 padding-20">
                  <div>
                    <h1 class="heading-style-h5">My Orders</h1>
                  </div>
                  <div class="bread-crumbs-container">
                    ...
                    <a href="../shop/my-order.html" aria-current="page" class="breadcrumbs w--current">My Orders</a>
                  </div>
                </div>
                <div id="w-node-b270d376-81da-c197-ec91-61a71f415eca-ae446d5a" data-current="Tab 1" data-easing="ease" data-duration-in="300" data-duration-out="100" class="tab w-tabs">
                  <div class="tabs-menu w-tab-menu">
                    ...
                    <a data-w-tab="Tab 2" class="tabs w-inline-block w-tab-link">
                      <div class="tab-text">Order Placed <span>(1)</span></div>
                    </a>
                    <a data-w-tab="Tab 3" class="tabs w-inline-block w-tab-link">
                      <div class="tab-text">Confirmed</div>
                    </a>
                    <a data-w-tab="Tab 4" class="tabs w-inline-block w-tab-link">
                      <div class="tab-text">On Delivery </div>
                    </a>
                    <a data-w-tab="Tab 5" class="tabs w-inline-block w-tab-link">
                      <div class="tab-text">Delivered <span>(1)</span></div>
                    </a>
                    <a data-w-tab="Tab 6" class="tabs w-inline-block w-tab-link">
                      <div class="tab-text">Cancelled</div>
                    </a>
                  </div>
                        ...
                        <div class="order-list-wrapper">
                          <div class="order-details-wrapper order-container">
                            <div class="order-id-wrapper">
                              <div class="order-cotent-wrapper no-border-right id-wrapper">
                                <div>Order ID:</div>
                                <div id="w-node-b270d376-81da-c197-ec91-61a71f415eeb-ae446d5a" class="order-id">2023 - 0127 - 07534221</div>
                              </div>
                              <div class="div-block-7">
                                <div class="order-cotent-wrapper order-tag-wrapper">
                                  <div id="w-node-b270d376-81da-c197-ec91-61a71f415eef-ae446d5a" class="not-resized">Payment Status:</div>
                                  <div id="w-node-b270d376-81da-c197-ec91-61a71f415ef1-ae446d5a" class="tag green">Paid</div>
                                </div>
                                <div class="order-cotent-wrapper no-border-right no-min">
                                  <div id="w-node-b270d376-81da-c197-ec91-61a71f415ef4-ae446d5a" class="not-resized">Order Status:</div>
                                  <div id="w-node-b270d376-81da-c197-ec91-61a71f415ef6-ae446d5a" class="tag yellow">Placed</div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="order-details-wrapper order-con-wrapper">
                            ...
                            <div class="summary-wrapper grid-summary">
                              ...
                              <div class="column _100">
                                <div class="name-container">
                                  <div class="option-con">
                                    <div>Options will be visible once the order status is complete</div>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="total-wrapper">
                            <div id="w-node-b270d376-81da-c197-ec91-61a71f415f1c-ae446d5a" class="order-cotent-wrapper total-amount-wrapper">
                              <div id="w-node-b270d376-81da-c197-ec91-61a71f415f1d-ae446d5a">Total Amount to Pay:</div>
                              <div id="w-node-b270d376-81da-c197-ec91-61a71f415f1f-ae446d5a" class="order-content text-color-blue">₱71,200</div>
                            </div>
                            <div class="order-cotent-wrapper total-amount-wrapper">
                              <a id="w-node-b270d376-81da-c197-ec91-61a71f415f22-ae446d5a" href="#" class="refund-btn">Request Refund</a>
                            </div>
                            <div class="order-cotent-wrapper total-amount-wrapper no-right">
                              <a href="#" class="arrow-link w-inline-block">
                                <div id="w-node-b270d376-81da-c197-ec91-61a71f415f26-ae446d5a">View more details</div><img src="../images/arrow.svg" loading="lazy" alt="">
                              </a>
                            </div>
                          </div>
                        </div>
                        <div class="order-list-wrapper">
                          <div class="order-details-wrapper order-container">
                            <div class="order-id-wrapper">
                              <div class="order-cotent-wrapper no-border-right id-wrapper">
                                <div>Order ID:</div>
                                <div id="w-node-aa188d5b-5266-0f99-db22-64f4c780d1fe-ae446d5a" class="order-id">2023 - 0127 - 07534221</div>
                              </div>
                              <div class="div-block-7">
                                <div class="order-cotent-wrapper order-tag-wrapper">
                                  <div class="not-resized">Payment Status:</div>
                                  <div id="w-node-aa188d5b-5266-0f99-db22-64f4c780d204-ae446d5a" class="tag green">Paid</div>
                                </div>
                                <div class="order-cotent-wrapper no-border-right no-min">
                                  <div class="not-resized">Order Status:</div>
                                  <div id="w-node-aa188d5b-5266-0f99-db22-64f4c780d209-ae446d5a" class="tag yellow">Placed</div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="order-details-wrapper order-con-wrapper">
                            ...
                            <div class="summary-wrapper grid-summary">
                              ...
                              <div id="w-node-_4d343d01-a507-2909-d82a-3d15c4470dc3-ae446d5a" class="option-con">
                                <div class="manage"><img src="../images/settings.svg" loading="lazy" alt="">
                                  <div>Manage Card</div>
                                </div>
                                <div class="detach"><img src="../images/detach.svg" loading="lazy" alt="">
                                  <div>Detach from Account</div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="total-wrapper">
                            <div id="w-node-aa188d5b-5266-0f99-db22-64f4c780d236-ae446d5a" class="order-cotent-wrapper total-amount-wrapper">
                              <div id="w-node-aa188d5b-5266-0f99-db22-64f4c780d237-ae446d5a">Total Amount to Pay:</div>
                              <div id="w-node-aa188d5b-5266-0f99-db22-64f4c780d239-ae446d5a" class="order-content text-color-blue">₱71,200</div>
                            </div>
                            <div class="order-cotent-wrapper total-amount-wrapper">
                              <a id="w-node-aa188d5b-5266-0f99-db22-64f4c780d23c-ae446d5a" href="#" class="refund-btn">Request Refund</a>
                            </div>
                            <div class="order-cotent-wrapper total-amount-wrapper no-right">
                              <a href="#" class="arrow-link w-inline-block">
                                <div id="w-node-aa188d5b-5266-0f99-db22-64f4c780d240-ae446d5a">View more details</div><img src="../images/arrow.svg" loading="lazy" alt="">
                              </a>
                            </div>
                          </div>
                        </div>
            ...
            <div class="footer-wrapper">
              ...
              <div id="w-node-ef992205-966c-748f-d053-488a176f95be-176f958f" class="signup-wrapper">
                ...
                <div class="form-block w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="665f147b743ba95cae446d5a" data-wf-element-id="ef992205-966c-748f-d053-488a176f95c4">
